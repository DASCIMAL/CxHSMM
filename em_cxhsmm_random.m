%
%[PI,A,P,D,B,loglik]=em_cxhsmm_random(Q,M,K,V,mobsq,numIter,threshold,...
%                              obsStateStr)
%
...
function [PI,A,P,D,B,loglik] = em_cxhsmm_random(Q,M,K,V,mobsq,numIter,threshold,obsStateStr)
...
[PI,A,P,D,B] = init_cxhsmm(Q,M,K,V,'random'); 
